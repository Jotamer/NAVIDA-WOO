...
idleoffsets = {'120', '111'} -- I recommend you have your idle offset at 0
leftoffsets = {'240', '110'}
downoffsets = {'150', '111'}
upoffsets = {'126', '121'}
rightoffsets = {'114', '110'}

leftMissoffsets = {'119', '110'}  -- you probably won't need these if it's for the opponent
downMissoffsets = {'119', '110'}  --
upMissoffsets = {'119', '110'}    --
rightMissoffsets = {'119', '110'} --
...
idle_xml_name = 'CHR_Merger Idle'
left_xml_name = 'CHR_Merger Left'
down_xml_name = 'CHR_Merger Down'
up_xml_name = 'CHR_Merger Up'
right_xml_name = 'CHR_Merger Right'

left_miss_xml_name = 'CHR_Merger Miss'   -- you probably won't need these if it's for the opponent
down_miss_xml_name = 'CHR_Merger Miss'   --
up_miss_xml_name = 'CHR_Merger Miss'       --
right_miss_xml_name = 'CHR_Merger Miss' --

left_alt_xml_name = 'CHR_Merger Left'
down_alt_xml_name = 'CHR_Merger Down'
up_alt_xml_name = 'CHR_Merger Up'
right_alt_xml_name = 'CHR_Merger Right'
...
name_of_character_xml = 'CHR_Merger'
name_of_character = 'merger-christmas'
name_of_notetype = 'patch'
