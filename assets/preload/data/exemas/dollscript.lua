...
idle_xml_name = 'TailsDollIdle'
left_xml_name = 'TailsDollLeft'
down_xml_name = 'TailsDollDown'
up_xml_name = 'TailsDollUp'
right_xml_name = 'TailsDollRight'

left_miss_xml_name = 'TailsDollMiss'   -- you probably won't need these if it's for the opponent
down_miss_xml_name = 'TailsDollMiss'   --
up_miss_xml_name = 'TailsDollMiss'       --
right_miss_xml_name = 'TailsDollMiss' --

left_alt_xml_name = 'TailsDollLeft'
down_alt_xml_name = 'TailsDollDown'
up_alt_xml_name = 'TailsDollUp'
right_alt_xml_name = 'TailsDollRight'
...
name_of_character_xml = 'TailsDollASS-ETS'
name_of_character = 'xmas-doll'
name_of_notetype = 'xmas-doll'
